        ...
        if ($features) {
            ...
            $session->message("
                <div class=\"alert alert-success alert-dismissible fade show\" role=\"alert\">
                  <strong><i class='mdi mdi-check'></i></strong> {$features->title} editado com sucesso.
                  <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">
                    <span aria-hidden=\"true\">&times;</span>
                  </button>
                </div>");
...
<?php $users_profile = Users::find_by_id($_SESSION['id']); ?>
    ...
    <head>
        ...
        <title>Editar Caracteristica - Administrator</title>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 offset-2 pl-3 pb-3 box-shadow mt-4">
                ...
                <form method="post" action="">
                    ...
                    <h4 class="h4 mt-4 pb-2" style="border-bottom: 1px solid #dee2e6!important;">Editar Caracteristica</h4>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?= $features->title; ?>" name="title" class="form-control" id="title"  placeholder="Digite o Nome do Pacote">
                    </div>

                    
                    <div class="form-group">
                        <label for="wedding_type">Tipo de Casamento</label>
                        ...
                        <?php foreach ($category as $categories) : ?>
                            <?php if($categories->id  == $features->category_id) : ?>
                                <option value="<?= $categories->id; ?>" selected>
                                    <?= $categories->wedding_type; ?> - Preço: <?= number_format($categories->price, 2); ?>
                                </option>
                            <?php else : ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="form-control" id="description" rows="3" placeholder="DEixe a descrição sobre o Casamento"><?= $features->description; ?></textarea>
                    </div>
