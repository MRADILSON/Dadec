...
<?php $users_profile = Users::find_by_id($_SESSION['id']); ?>
    ...
    <head>
        ...
        <title>Carregar Foto - Administrador</title>
            ...
            <div class="col-lg-8 pl-3 pb-3 box-shadow mt-4 pt-3">
                ...
                <form method="post" action="" enctype="multipart/form-data">
                  <div class="form-group">
                    <label for="booking_id">Foto de Capa</label>
                   ...
                   <div class="form-group">
                       ...
                       <input type="text" name="title" value="<?= $gallery->title; ?>" class="form-control" placeholder="Digite o titulo">
                   </div>
                    <div class="form-group">
                   ...
                   <input type="submit" name="submit" value="Editar" class="btn btn-light btn-sm">
                   <input type="reset" name="Clear" class="btn btn-danger btn-sm">
                   <a href="photos_view.php" class="btn btn-light btn-sm float-right">Voltar</a>
                ...
                <div class="photos-view mt-4">
                    <div class="card" style="width: 100%;">
                      ...
                      <ul class="list-group list-group-flush">
                        <li class="list-group-item"><i class="mdi mdi-file-document"></i> Nome do Ficheiro: <?= $gallery->filename; ?></li>
                        <li class="list-group-item"><i class="mdi mdi-file-document"></i> Tamnho da Foto: <?= formatBytes($gallery->size); ?></li>
                        <li class="list-group-item"><i class="mdi mdi-file-document"></i> Tipo de Ficheiro: <?= $gallery->type; ?></li>
                      </ul>
