        ...
        if ($event_wedding) {
            ...
            if(empty($_FILES['preview_image'])){
                ...
                <div class=\"alert alert-success alert-dismissible fade show\" role=\"alert\">
                  <strong><i class='mdi mdi-account-alert mr-2'></i></strong> {$event_wedding->title} atualizado com sucesso.
                  <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">
                    <span aria-hidden=\"true\">&times;</span>
                  </button>
                </div>");
                ...
                $session->message("
                <div class=\"alert alert-success alert-dismissible fade show\" role=\"alert\">
                  <strong><i class='mdi mdi-account-alert mr-2'></i></strong> The {$event_wedding->title} atualizado com sucesso.
                  <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">
                    <span aria-hidden=\"true\">&times;</span>
                  </button>
                </div>");
...
<?php $users_profile = Users::find_by_id($_SESSION['id']); ?>
    ...
    <html lang="pt">
    <head>
        <title>Editar Publicação - Administrator</title>
        <?php
        ...
        <div class="row">
            ...
            <div class="col-lg-8 pl-3 pb-3 box-shadow mt-4">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <h4 class="h4 mt-4 pb-2" style="border-bottom: 1px solid #dee2e6!important;">Editar Publicação
<br><br>
            ...
            <button type="submit" name="submit" class="btn btn-sm btn-success float-right mr-2" style="font-size: 12px;"><i class="mdi mdi-account-plus mr-2"></i> Editar</button>
                        ...
                        <div class="form-group">
                            <label for="booking_id">Relacionado:</label>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" cols="30" rows="10" class="form-control" placeholder="Digite a Descrição do evento"><?= $event_wedding->description; ?></textarea>
                    </div>

                    <div class="form-row">
                      
                        <div class="form-group col-md-6">
                            <label >Prever Imagem</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="location" class="form-control" value="<?= $event_wedding->location; ?>" id="location" placeholder="Digite a Localização">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" id="status" class="form-control">
                            <?php if($event_wedding->status == '0') : ?>
                                <option value="0" selected>Elaborado</option>
