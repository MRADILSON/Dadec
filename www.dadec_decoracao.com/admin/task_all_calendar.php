...
<?php
    ...
    $bdd = new PDO('mysql:host=localhost;dbname=db_decoracao_evento', 'root', '');
...
$gallery = Gallery::find_by_id($_SESSION['id']);
?>
<!doctype html>
<html lang="pt">
<head>
       
<title>Calendário - Administrator</title>
    <?php
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
      <h5 class="h4 mt-4 ml-3" style="text-align: center;">Calendário de Eventos</h5>
</div>
            ...
            <form class="form-horizontal" method="POST" action="task_event_save.php">
              ...
              <div class="modal-body">
                  ...
                  <div class="form-group">
                      <label for="booking_id">Par:</label>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="start" class="">Data de Inicio:</label>
                        <input type="text" name="start" class="form-control" id="start" readonly>
                    </div>

                  <div class="form-group">
                    <label for="end" class=" ">Data do Fim</label>
            ...
            <form class="form-horizontal" method="POST" action="task_editEventTitle.php">
              ...
              <div class="modal-body">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                      <input type="text" name="location" class="form-control" id="location" placeholder="Localização">
                  </div>
