...
class DB_Object
{
    ...
    public static function find_all_material() {
        return static::find_by_query("SELECT * FROM " . static::$db_table . " ORDER BY id DESC");
    }
    ...
    public function find_by_id_material($id) {
        $the_result_array = static::find_by_query("SELECT * FROM " . static::$db_table . " WHERE id = $id ORDER BY id DESC  LIMIT 1 ");
        return !empty($the_result_array) ? array_shift($the_result_array) : false;
    }
    ...
    public static function find_client_id($id) {
        $the_result_array = static::find_by_query("SELECT * FROM " . static::$db_table . " WHERE id = $id LIMIT 1");
        return !empty($the_result_array) ? array_shift($the_result_array) : false;
    }

    public static function find_by_material_id($id) {
        $the_result_array = static::find_by_query("SELECT * FROM " . static::$db_table . " WHERE id_material = $id LIMIT 1");
        return !empty($the_result_array) ? array_shift($the_result_array) : false;
    }
