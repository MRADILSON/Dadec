...
<nav class="navbar sticky-top p-0" style="width: 16.7%;background-color: #f44336;">
    <a class="navbar-brand col-sm-3 col-md-2 mr-0" style="color:white;text-right:center;" href="dashboard.php">
        <!-- <img src="images/admin.png" alt="" style="width: 200px;"> -->
        <b>DADEC</b> - Administrator
    </a>
</nav>
        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
            <div class="sidebar-sticky">
                <ul class="nav flex-column">
                    <li class="nav-item mt-3">
                        <div class="text-center">
                            <a href="users_profile.php" class="user-button">
                                ...
                                <div class="user-profile"> <b> <?= $users_profile->primeironome . ' ' . $users_profile->ultimonome; ?> </b></div>
                            </a>
                                <div class="text-center mt-0" style="font-size: 11px;color:#72777a;">
                                    <?= ($users_profile->designacao == 0) ? 'Administrator' : 'Moderator'; ?>
                                </div>
                        </div>
                    </li>
                    ...
                    <li class="nav-item"><div class="dropdown-divider"></div></li>
                    <li class="nav-item">
                        <a class="nav-link" href="pagamento1.php">
                    ...
                    <li class="nav-item"><div class="dropdown-divider"></div></li>     
                    <li class="nav-item">
                        <a class="nav-link" href="/php-chat-app-main/chat.php">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="service_list.php">
                            <i class="mdi mdi-cash budget-icon mr-3" style="color: orange;"></i>
                            Orçamentos
                        </a>
                    </li>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10" style="margin-top: -40px;z-index: 999">
            <nav class="navbar navbar-expand-lg navbar-light bg-light" style="margin-left:-15px;margin-right: -15px;">
                ...
                <div class="form-inline my-2 my-lg-0">
                    <a class="nav-link" href="users_profile.php"><b><?= ucfirst($users_profile->primeironome) . ' ' . ucfirst($users_profile->ultimonome); ?></b></a>
                    <a class="nav-link" href="logout.php"><b><i class="mdi mdi-logout" style="color: #f44336!important;"></i> Sair</b></a>
                </div>
            </nav>