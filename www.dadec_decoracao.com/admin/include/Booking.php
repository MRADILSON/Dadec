...
class Booking extends DB_Object
{
    ...
    public static function getBooking() {
        global $db;
        $sql = "SELECT * FROM tblaccounts_detail INNER JOIN tblweddingbook ON tblweddingbook.user_id = tblaccounts_detail.user_id WHERE tblaccounts_detail.status = 'Pendente' ORDER BY booking_id ASC";
