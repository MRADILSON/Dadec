...
<head>
    ...
    <title>Galeria de Photos - Administrador</title>
    ...
    <h4 class="h4 mt-4">Galeria de Fotos </h4>
     <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group mr-2">
            <a class="btn btn-light mr-2 text-uppercase" style="font-size: 12px;font-weight: bold;" href="photos_add.php"><i class="mdi mdi-upload mr-2"></i> Carregar Imagem</a>
        </div>
    </div>
</div>
<?php
