    ...
    if (isset($_POST['submit']) || isset($_FILES['preview_image'])) {
        ...
        $quantidade = clean($_POST['quantidade']);
         ...
         if (empty($nome_material) || empty($preco) || empty($quantidade)) {
            redirect_to("material_edit.php?id=".$_GET['id']);
            $session->message("
        ...
        <div class="row">
            ...
            <div class="col-lg-8 pl-3 pb-3 box-shadow mt-4">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <?= isset($msg) ? $msg : ''; ?>
                    <h4 class="h4 mt-4 pb-2" style="border-bottom: 1px solid #dee2e6!important;">Editar Materiais
                    <br><br>
                    <div class="btn-group mr-2">
                        ...
                        <input type="text" name="nome" class="form-control" id="nome" value="<?= $material->nome; ?>"  placeholder="Digite o Nome do Material">
                        </div>

                        <div class="form-group">
                        <label for="wedding_type">Preço Unitário:</label>
                        <input type="text" name="preco" class="form-control" id="preco" value="<?= $material->preco; ?>" placeholder="Digite o Preço do Material">
                        </div>

                        <div class="form-group">
                        <label for="wedding_type">Quantidade</label>
                        <input type="text" name="quantidade" class="form-control" id="quantidade" value="<?= $material->quantidade; ?>"  placeholder="Digite a Quantidade do Material">
                        </div>
            ...
            <div class="col-lg-3 mt-4">
                <img id="preview_image" src="<?= $material->preview_image_picture(); ?>" width="300" height="350" alt="Imagem">
            </div>
        </div>
    </div>
