        ...
        $salario = clean($_POST['salario']);
         ...
         if (empty($nome_funcionario) || empty($idade) || empty($contacto) || empty($endereco) || empty($funcao) || empty($salario)){
            ...
            <div class=\"alert alert-danger alert-dismissible fade show\" role=\"alert\">
              <strong><i class='mdi mdi-account-alert mr-2'></i></strong> Por favor preencha os campos vazios.
        ...
        $funcionario->salario = $salario;
         ...
         if ($funcionario->save()) {
            ...
            <div class=\"alert alert-success alert-dismissible fade show\" role=\"alert\">
              <strong><i class='mdi mdi-account-alert mr-2'></i></strong> O {$funcionario->nome} adicionado com sucesso.
              <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">
                <span aria-hidden=\"true\">&times;</span>
              </button>
            </div>");
        ...
        <div class="row">
            ...
            <div class="col-lg-8 pl-3 pb-3 box-shadow mt-4">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <?= isset($msg) ? $msg : ''; ?>
                    <h4 class="h4 mt-4 pb-2" style="border-bottom: 1px solid #dee2e6!important;">Cadastrar Funcionários

                        <a href="material_add.php" class="btn btn-sm btn-danger float-right" style="font-size: 12px;"><i class="mdi mdi-close-circle mr-2"></i> Cancelar</a>
                        ...
                        <input type="text" name="nome" class="form-control" id="nome"  placeholder="Digite o Nome do Funcionario">
                        </div>

                        <div class="form-group">
                        <label for="wedding_type">Idade:</label>
                        <input type="text" name="idade" class="form-control" id="idade"  placeholder="Digite a Idade do Funcionário">
                        </div>

                        <div class="form-group">
                        <label for="wedding_type">Contacto:</label>
                        <input type="text" name="contacto" class="form-control" id="contacto"  placeholder="Digite o Número de Telefone">
                        </div>

                        <div class="form-group">
                        <label for="wedding_type">Endereço:</label>
                        <input type="text" name="endereco" class="form-control" id="endereco"  placeholder="Digite o Endreço">
                        </div>
