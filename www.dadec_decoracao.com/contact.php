...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            <h3 class="text-center mb-3">NOS CONTACTE</h3>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <table class="table table-sm" style="font-size: 12px;">
                                <tr>
                                    <td>Daniel Zacarias</td>
                                    <td><i class="mdi mdi-deskphone mr-3"></i>(244) 926 332 443</td>
                                </tr>
                                <tr>
                                    <td>Whatsapp</td>
                                    <td><i class="mdi mdi-phone mr-3"></i> (244) 926 332 443</td>
                                </tr>
                                <tr>
                                    <td>Email</td>
                                    <td><i class="mdi mdi-email mr-3"></i> danielzacariasdc@gmail.com</td>
                                </tr>
                                <tr>
                                    <td>Visite a Página</td>
                                    <td><i class="mdi mdi-email mr-3"></i> <a href="https://www.facebook.com/profile.php?id=100085527782996 
">DADEC - Decorações</a></td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-md-4">
