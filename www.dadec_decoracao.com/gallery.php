...
<head>
    ...
    <style>
        ...
        /* Estilos adicionais para largura de tela de 360px */
        @media (max-width: 360px) {
            .row{
                margin-top: 100px;
            }
            .navbar-brand {
                margin-left: 10px; /* Reduz a margem esquerda do logotipo */
                width: auto; /* Deixe o logotipo ocupar o espaço necessário */
                font-size: 14px; /* Reduz o tamanho da fonte do logotipo */
            }
            .card-columns {
                column-count: 1; /* Ajusta o layout para uma coluna em telas estreitas */
            }
            .card {
                margin-bottom: 20px; /* Adiciona espaço entre os cards */
            }
            .card-body {
                padding: 10px; /* Adiciona espaço interno ao corpo do card */
            }
            .card-title {
                font-size: 10px; /* Reduz o tamanho da fonte do título do card */
            }
        }
...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            <h4 class="text-center mb-0 mt-5">Fotos de Casamentos</h4>
            <p class="text-center mt-0 text-muted">Fotos que capturam os teus Momentos</p>
